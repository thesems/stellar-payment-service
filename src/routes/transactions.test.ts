  ...
  it("prepares an unsigned native payment transaction and creates a transaction record", async () => {
    ...
    expect(response.json()).toMatchObject({
      ...
      transaction: {
        ...
        network: "testnet",
        chain_id: null,
        source_address: stellarKey("A"),
        destination_address: stellarKey("B"),
        prepared_transaction: "unsigned-envelope-xdr",
        prepared_payload: "unsigned-envelope-xdr",
      },
    });
    ...
    expect(response.json()).toMatchObject({
      transactions: [
        ...
        },
        {
          ...
          protocol: "stellar",
          network: "testnet",
          source_address: stellarKey("C"),
          destination_address: stellarKey("A"),
